...
# tokenCounter: the number of all tokens (lines - blanks)
# foundCorrect: total correct blocks
# foundGuessed: total guessed blocks
# correctChunk: succeed match blocks
# correctTags:  total match tags, including O-O and not considing blocks
# foundCorrect - coundGuessed = the block cannot be found (O, either correct or wrong)
